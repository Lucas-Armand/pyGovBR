    ...
    if request.method == "POST":
        ...
        if 'cnpj' in form.keys():
            ...
            return render_to_response('board/dashboard.html',                   
                                       {"nome_empresa" : "Albatroz Seguranca e Vigilancia Ltda",
                                        "cnpj" : "66.700.295/0001-17",           
                                        "nome_1": 'VALOR ANUAL MÉDIO DOS CONTRATOS',
                                        "valor_contrato_ano":  ind['VALOR MEDIO DE CONTRATOS'],  
                                        "nome_2": "QUANTIDADE DE CONTRATOS POR ANO",
                                        "n_contrato_ano": ind['NUMERO MEDIO DE CONTRATO POR ANO'],                  
